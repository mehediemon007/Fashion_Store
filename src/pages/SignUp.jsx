                    ...
                    <div className='sign-form-wpr'>
                        <div className="sign-form">
                            <div className="social-sign-links">
                                <a href="https://www.facebook.com/" className='social-sign'><i class="fa-brands fa-facebook"></i> Sign Up With Facebook</a>
                                <a href="https://www.facebook.com/" className='social-sign gmail-sign'><i class="fa-brands fa-google-plus-square"></i> Sign Up With Gmail</a>
